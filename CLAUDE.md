...
React Native mobile application for the BunnyFinder project.

**Package**: `entityentitybunnyfinder_app_rn` (private)
...
Custom `NetworkClient` implementation (fetch-based) — does not use the web DI layer. Configured via `ApiContext` which provides the entitybunnyfinder_client and QueryClient.
...
- **entitybunnyfinder_types** — Shared type definitions
- **entitybunnyfinder_client** — API client SDK
- **entitybunnyfinder_lib** — Business logic library with `useHistoriesManager`
- **entitybunnyfinder_api** — Backend server this app communicates with
- **entitybunnyfinder_app** — Web counterpart of this mobile app; shares entitybunnyfinder_client, entitybunnyfinder_lib, and entitybunnyfinder_types
